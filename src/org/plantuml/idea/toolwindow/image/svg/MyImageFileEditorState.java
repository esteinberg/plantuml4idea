 ...
 */
public class MyImageFileEditorState implements TransferableFileEditorState, Serializable {
    ...
    MyImageFileEditorState(boolean backgroundVisible, boolean gridVisible, double zoomFactor, boolean zoomFactorChanged) {
